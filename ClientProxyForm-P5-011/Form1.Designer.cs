namespace ClientProxyForm_P5_011
{
	partial class Form1
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// buttonHasil
			// 
			this.buttonHasil.Location = new System.Drawing.Point(182, 236);
			...
			this.label6.Location = new System.Drawing.Point(333, 170);
			...
			this.labelPenjumlahan.Location = new System.Drawing.Point(440, 88);
			this.labelPenjumlahan.Name = "labelPenjumlahan";
			this.labelPenjumlahan.Size = new System.Drawing.Size(35, 13);
			this.labelPenjumlahan.TabIndex = 9;
			this.labelPenjumlahan.Text = "label3";
			// 
			// labelPengurangan
			// 
			this.labelPengurangan.AutoSize = true;
			this.labelPengurangan.Location = new System.Drawing.Point(440, 113);
			this.labelPengurangan.Name = "labelPengurangan";
			this.labelPengurangan.Size = new System.Drawing.Size(35, 13);
			this.labelPengurangan.TabIndex = 10;
			this.labelPengurangan.Text = "label4";
			// 
			// labelPerkalian
			// 
			this.labelPerkalian.AutoSize = true;
			this.labelPerkalian.Location = new System.Drawing.Point(440, 140);
			this.labelPerkalian.Name = "labelPerkalian";
			this.labelPerkalian.Size = new System.Drawing.Size(35, 13);
			this.labelPerkalian.TabIndex = 11;
			this.labelPerkalian.Text = "label5";
			// 
			// labelPembagian
			// 
			this.labelPembagian.AutoSize = true;
			this.labelPembagian.Location = new System.Drawing.Point(440, 170);
			this.labelPembagian.Name = "labelPembagian";
			this.labelPembagian.Size = new System.Drawing.Size(35, 13);
			this.labelPembagian.TabIndex = 12;
			this.labelPembagian.Text = "label6";
			// 
			// Form1
			// 
